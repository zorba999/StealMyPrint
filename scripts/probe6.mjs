...
const code = new Uint8Array(readFileSync("scripts/probe6.py"));
...
console.log("addr", addr, r.consensus_data?.leader_receipt?.[0]?.execution_result);
console.log(await client.readContract({ address: addr, functionName: "get", args: [] }));
